...
//Date        : Wed Sep 27 17:41:54 2017
//Host        : pc-klas3-12.esat.kuleuven.be running 64-bit CentOS Linux release 7.4.1708 (Core)
//Command     : generate_target montgomery_sw_project_wrapper.bd
//Design      : montgomery_sw_project_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module montgomery_sw_project_wrapper
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  montgomery_sw_project montgomery_sw_project_i
       (.DDR_addr(DDR_addr),
        .DDR_ba(DDR_ba),
        .DDR_cas_n(DDR_cas_n),
        .DDR_ck_n(DDR_ck_n),
