...
HD_PWD='/users/start2015/r0486429/Documents/DDP/exsession2/ddp_sw/montgomery_sw_project/montgomery_sw_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log montgomery_sw_project_wrapper.vdi -applog -m64 -tempDir /tmp -messageDb vivado.pb -mode batch -source montgomery_sw_project_wrapper.tcl -notrace
