...
HD_PWD='/users/students/data/eagle4/project_Attitude_Controller/project_Attitude_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ARM_1_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ARM_1_wrapper.tcl
