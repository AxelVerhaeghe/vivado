...
HD_PWD='/users/students/data/eagle4/project_Attitude_Controller/project_Attitude_Controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ARM_1_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ARM_1_wrapper.tcl -notrace
