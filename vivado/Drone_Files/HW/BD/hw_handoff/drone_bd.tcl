...
################################################################
# This is a generated script based on design: drone
#
...
if { $run_remote_bd_flow == 1 } {
  set str_bd_folder /users/students/data/eagle4/Drone_files/Drone_Files/HW/BD
...
proc create_root_design { parentCell } {
  ...
  set gpio_testpin [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 gpio_testpin ]
  ...
  set BR [ create_bd_port -dir O BR ]
  ...
  set FL [ create_bd_port -dir O FL ]
  set FR [ create_bd_port -dir O FR ]
  set HDMI_OEN [ create_bd_port -dir O -from 0 -to 0 HDMI_OEN ]
  set Mode_switch [ create_bd_port -dir I Mode_switch ]
  set PWM_inductive [ create_bd_port -dir O PWM_inductive ]
  set Sonar [ create_bd_port -dir I Sonar ]
  set Sounder [ create_bd_port -dir O Sounder ]
  set aile [ create_bd_port -dir I aile ]
  set elev [ create_bd_port -dir I elev ]
  set mode_inductive [ create_bd_port -dir I mode_inductive ]
  set rc_kill [ create_bd_port -dir I rc_kill ]
  set rc_kill_out [ create_bd_port -dir O rc_kill_out ]
  set rudd [ create_bd_port -dir I rudd ]
  set throttle [ create_bd_port -dir I throttle ]
  set tuner [ create_bd_port -dir I tuner ]
...
CONFIG.DOUT_WIDTH {8} \
  ...
  # Create instance: DVBOutputBuffer_0, and set properties
  set DVBOutputBuffer_0 [ create_bd_cell -type ip -vlnv bertold.org:EagleTX:DVBOutputBuffer:1.0 DVBOutputBuffer_0 ]
...
CONFIG.DOUT_WIDTH {8} \
  ...
  # Create instance: ModemS2Control_0, and set properties
  set ModemS2Control_0 [ create_bd_cell -type ip -vlnv bertold.org:user:ModemS2Control:1.0 ModemS2Control_0 ]

  # Create instance: ModemS2Zybo_0, and set properties
  set ModemS2Zybo_0 [ create_bd_cell -type ip -vlnv user.org:user:ModemS2Zybo:1.0 ModemS2Zybo_0 ]

  # Create instance: PWM_AXI_triple_0, and set properties
  set PWM_AXI_triple_0 [ create_bd_cell -type ip -vlnv kuleuven.be:user:PWM_AXI_triple:1.0 PWM_AXI_triple_0 ]
  set_property -dict [ list \
CONFIG.C_S00_AXI_BASEADDR {0x43C30000} \
CONFIG.C_S00_AXI_HIGHADDR {0x43C3FFFF} \
 ] $PWM_AXI_triple_0

  # Create instance: PWM_AXI_triple_3, and set properties
  set PWM_AXI_triple_3 [ create_bd_cell -type ip -vlnv kuleuven.be:user:PWM_AXI_triple:1.0 PWM_AXI_triple_3 ]
  set_property -dict [ list \
CONFIG.C_S00_AXI_BASEADDR {0x43C40000} \
CONFIG.C_S00_AXI_HIGHADDR {0x43C4FFFF} \
 ] $PWM_AXI_triple_3

  # Create instance: PWM_AXI_triple_4, and set properties
  set PWM_AXI_triple_4 [ create_bd_cell -type ip -vlnv kuleuven.be:user:PWM_AXI_triple:1.0 PWM_AXI_triple_4 ]
  set_property -dict [ list \
CONFIG.C_S00_AXI_BASEADDR {0x43C40000} \
CONFIG.C_S00_AXI_HIGHADDR {0x43C4FFFF} \
 ] $PWM_AXI_triple_4

  # Create instance: PWM_AXI_triple_5, and set properties
  set PWM_AXI_triple_5 [ create_bd_cell -type ip -vlnv kuleuven.be:user:PWM_AXI_triple:1.0 PWM_AXI_triple_5 ]
  set_property -dict [ list \
CONFIG.C_S00_AXI_BASEADDR {0x43C40000} \
CONFIG.C_S00_AXI_HIGHADDR {0x43C4FFFF} \
 ] $PWM_AXI_triple_5
...
CONFIG.DOUT_WIDTH {8} \
  ...
  set_property -dict [ list \
CONFIG.C_S00_AXI_BASEADDR {0x43C80000} \
CONFIG.C_S00_AXI_HIGHADDR {0x43C8FFFF} \
 ] $RC_0

  # Create instance: RC_1, and set properties
  set RC_1 [ create_bd_cell -type ip -vlnv kuleuven.be:user:RC:1.0 RC_1 ]
  set_property -dict [ list \
CONFIG.C_S00_AXI_BASEADDR {0x43c90000} \
CONFIG.C_S00_AXI_HIGHADDR {0x43c9ffff} \
 ] $RC_1
...
CONFIG.C_IS_DUAL {1} \
  ...
  # Create instance: axi_gpio_testpins, and set properties
  set axi_gpio_testpins [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_testpins ]
  set_property -dict [ list \
CONFIG.C_ALL_OUTPUTS {1} \
...
CONFIG.Use_Extra_Logic {false} \
  ...
  # Create instance: kill_switch_0, and set properties
  set kill_switch_0 [ create_bd_cell -type ip -vlnv kuleuven.be:user:kill_switch:1.0 kill_switch_0 ]
...
CONFIG.PCW_ACT_FPGA3_PERIPHERAL_FREQMHZ {76.923080} \
...
CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#GPIO#GPIO#GPIO#GPIO#I2C 0#I2C 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#USB Reset#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0} \
...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_testpins_GPIO [get_bd_intf_ports gpio_testpin] [get_bd_intf_pins axi_gpio_testpins/GPIO]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_IIC_1 [get_bd_intf_ports IIC_0] [get_bd_intf_pins processing_system7_0/IIC_1]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins RC_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins RC_1/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M03_AXI [get_bd_intf_pins DVBOutputBuffer_0/axi] [get_bd_intf_pins processing_system7_0_axi_periph/M03_AXI]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M06_AXI [get_bd_intf_pins PWM_AXI_triple_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M06_AXI]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M08_AXI [get_bd_intf_pins PWM_AXI_triple_3/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M09_AXI [get_bd_intf_pins PWM_AXI_triple_4/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M09_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M10_AXI [get_bd_intf_pins PWM_AXI_triple_5/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M10_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M11_AXI [get_bd_intf_pins axi_gpio_testpins/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M11_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M12_AXI [get_bd_intf_pins axi_dma_0/S_AXI_LITE] [get_bd_intf_pins processing_system7_0_axi_periph/M12_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M13_AXI [get_bd_intf_pins ModemS2Control_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M13_AXI]
  ...
  connect_bd_net -net B_Dout [get_bd_pins B/Dout] [get_bd_pins xlconcat_1/In1]
  ...
  connect_bd_net -net DVBOutputBuffer_0_fifo_rd_en [get_bd_pins DVBOutputBuffer_0/fifo_rd_en] [get_bd_pins fifo_generator_0/rd_en]
  connect_bd_net -net G_Dout [get_bd_pins G/Dout] [get_bd_pins xlconcat_1/In2]
  connect_bd_net -net Mode_switch_1 [get_bd_ports Mode_switch] [get_bd_pins RC_1/RC_in0]
  connect_bd_net -net ModemS2Control_0_ctrl_allowDummy [get_bd_pins ModemS2Control_0/ctrl_allowDummy] [get_bd_pins ModemS2Zybo_0/ctrl_allowDummy]
  connect_bd_net -net ModemS2Control_0_ctrl_blockSize [get_bd_pins ModemS2Control_0/ctrl_blockSize] [get_bd_pins ModemS2Zybo_0/ctrl_blockSize]
  connect_bd_net -net ModemS2Control_0_ctrl_modCod [get_bd_pins ModemS2Control_0/ctrl_modCod] [get_bd_pins ModemS2Zybo_0/ctrl_modCod]
  connect_bd_net -net ModemS2Control_0_ctrl_nullPid [get_bd_pins ModemS2Control_0/ctrl_nullPid] [get_bd_pins ModemS2Zybo_0/ctrl_nullPid]
  connect_bd_net -net ModemS2Control_0_ctrl_padNull [get_bd_pins ModemS2Control_0/ctrl_padNull] [get_bd_pins ModemS2Zybo_0/ctrl_padNull]
  connect_bd_net -net ModemS2Control_0_ctrl_pilot [get_bd_pins ModemS2Control_0/ctrl_pilot] [get_bd_pins ModemS2Zybo_0/ctrl_pilot]
  connect_bd_net -net ModemS2Control_0_ctrl_reset [get_bd_pins ModemS2Control_0/ctrl_reset] [get_bd_pins ModemS2Zybo_0/ctrl_reset]
  connect_bd_net -net ModemS2Control_0_modem_gain [get_bd_pins ModemS2Control_0/modem_gain] [get_bd_pins ModemS2Zybo_0/modem_gain]
  connect_bd_net -net ModemS2Control_0_modem_int_config [get_bd_pins ModemS2Control_0/modem_int_config] [get_bd_pins ModemS2Zybo_0/modem_int_config]
  connect_bd_net -net ModemS2Control_0_modem_rolloff_config [get_bd_pins ModemS2Control_0/modem_rolloff_config] [get_bd_pins ModemS2Zybo_0/modem_rolloff_config]
  connect_bd_net -net ModemS2Control_0_out_data_config [get_bd_pins ModemS2Control_0/out_data_config] [get_bd_pins ModemS2Zybo_0/out_data_config]
  connect_bd_net -net ModemS2Zybo_0_fifo_data [get_bd_pins ModemS2Zybo_0/fifo_data] [get_bd_pins fifo_generator_0/din]
  connect_bd_net -net ModemS2Zybo_0_fifo_wr_en [get_bd_pins ModemS2Zybo_0/fifo_wr_en] [get_bd_pins fifo_generator_0/wr_en]
  connect_bd_net -net ModemS2Zybo_0_mpeg_input0_readyForPreviousBlock [get_bd_pins ModemS2Zybo_0/mpeg_input0_readyForPreviousBlock] [get_bd_pins axi_dma_0/m_axis_mm2s_tready]
  connect_bd_net -net PWM_AXI_triple_0_PWM_out0 [get_bd_pins PWM_AXI_triple_0/PWM_out0] [get_bd_pins kill_switch_0/pwm0]
  connect_bd_net -net PWM_AXI_triple_0_PWM_out1 [get_bd_pins PWM_AXI_triple_0/PWM_out1] [get_bd_pins kill_switch_0/pwm1]
  connect_bd_net -net PWM_AXI_triple_0_PWM_out2 [get_bd_pins PWM_AXI_triple_0/PWM_out2] [get_bd_pins kill_switch_0/pwm2]
  connect_bd_net -net PWM_AXI_triple_3_PWM_out0 [get_bd_pins PWM_AXI_triple_3/PWM_out0] [get_bd_pins kill_switch_0/pwm3]
  connect_bd_net -net PWM_AXI_triple_4_PWM_out0 [get_bd_ports PWM_inductive] [get_bd_pins PWM_AXI_triple_4/PWM_out0]
  connect_bd_net -net PWM_AXI_triple_5_PWM_out0 [get_bd_ports Sounder] [get_bd_pins PWM_AXI_triple_5/PWM_out0]
  connect_bd_net -net RC_in_3_1 [get_bd_ports rudd] [get_bd_pins RC_0/RC_in3]
  connect_bd_net -net R_Dout [get_bd_pins R/Dout] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net Sonar_1 [get_bd_ports Sonar] [get_bd_pins RC_1/RC_in1]
  connect_bd_net -net aile_1 [get_bd_ports aile] [get_bd_pins RC_0/RC_in1]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tdata [get_bd_pins ModemS2Zybo_0/mpeg_input0_data] [get_bd_pins axi_dma_0/m_axis_mm2s_tdata]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tvalid [get_bd_pins ModemS2Zybo_0/mpeg_input0_inputValid] [get_bd_pins axi_dma_0/m_axis_mm2s_tvalid]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net axi_gpio_led_gpio2_io_o [get_bd_pins axi_gpio_led/gpio2_io_o] [get_bd_pins kill_switch_0/heartbeat]
  connect_bd_net -net axi_gpio_video_ip2intc_irpt [get_bd_pins axi_gpio_video/ip2intc_irpt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net axi_vdma_0_s2mm_introut [get_bd_pins axi_vdma_0/s2mm_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net dvi2rgb_0_PixelClk [get_bd_pins dvi2rgb_0/PixelClk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins v_tc_0/clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  ...
  connect_bd_net -net dvi2rgb_0_vid_pData [get_bd_pins B/Din] [get_bd_pins G/Din] [get_bd_pins R/Din] [get_bd_pins dvi2rgb_0/vid_pData]
  ...
  connect_bd_net -net elev_1 [get_bd_ports elev] [get_bd_pins RC_0/RC_in2]
  connect_bd_net -net fifo_generator_0_dout [get_bd_pins DVBOutputBuffer_0/fifo_dout] [get_bd_pins fifo_generator_0/dout]
  connect_bd_net -net fifo_generator_0_empty [get_bd_pins DVBOutputBuffer_0/fifo_empty] [get_bd_pins fifo_generator_0/empty]
  connect_bd_net -net fifo_generator_0_full [get_bd_pins ModemS2Zybo_0/fifo_full] [get_bd_pins fifo_generator_0/full]
  connect_bd_net -net kill_switch_0_pwmo_0 [get_bd_ports FL] [get_bd_pins kill_switch_0/pwmo_0]
  connect_bd_net -net kill_switch_0_pwmo_1 [get_bd_ports FR] [get_bd_pins kill_switch_0/pwmo_1]
  connect_bd_net -net kill_switch_0_pwmo_2 [get_bd_ports BL] [get_bd_pins kill_switch_0/pwmo_2]
  connect_bd_net -net kill_switch_0_pwmo_3 [get_bd_ports BR] [get_bd_pins kill_switch_0/pwmo_3]
  connect_bd_net -net kill_switch_0_rc_kill_out [get_bd_ports rc_kill_out] [get_bd_pins kill_switch_0/total_kill_out]
  connect_bd_net -net mode_inductive_1 [get_bd_ports mode_inductive] [get_bd_pins RC_1/RC_in2]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins DVBOutputBuffer_0/axi_aclk] [get_bd_pins PWM_AXI_triple_0/s00_axi_aclk] [get_bd_pins PWM_AXI_triple_3/s00_axi_aclk] [get_bd_pins PWM_AXI_triple_4/s00_axi_aclk] [get_bd_pins PWM_AXI_triple_5/s00_axi_aclk] [get_bd_pins RC_0/s00_axi_aclk] [get_bd_pins RC_1/s00_axi_aclk] [get_bd_pins axi_gpio_led/s_axi_aclk] [get_bd_pins axi_gpio_testpins/s_axi_aclk] [get_bd_pins axi_gpio_video/s_axi_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins fifo_generator_0/rd_clk] [get_bd_pins kill_switch_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/M06_ACLK] [get_bd_pins processing_system7_0_axi_periph/M07_ACLK] [get_bd_pins processing_system7_0_axi_periph/M08_ACLK] [get_bd_pins processing_system7_0_axi_periph/M09_ACLK] [get_bd_pins processing_system7_0_axi_periph/M10_ACLK] [get_bd_pins processing_system7_0_axi_periph/M11_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins v_tc_0/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_processing_system7_0_150M/slowest_sync_clk] [get_bd_pins v_vid_in_axi4s_0/aclk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_pins ModemS2Control_0/s00_axi_aclk] [get_bd_pins ModemS2Zybo_0/clk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins fifo_generator_0/wr_clk] [get_bd_pins processing_system7_0/FCLK_CLK3] [get_bd_pins processing_system7_0_axi_periph/M12_ACLK] [get_bd_pins processing_system7_0_axi_periph/M13_ACLK] [get_bd_pins rst_processing_system7_0_100M1/slowest_sync_clk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET3_N [get_bd_pins processing_system7_0/FCLK_RESET3_N] [get_bd_pins rst_processing_system7_0_100M1/ext_reset_in]
  connect_bd_net -net rc_kill_1 [get_bd_ports FCLK_CLK0] [get_bd_ports rc_kill] [get_bd_pins kill_switch_0/rc_kill]
  connect_bd_net -net rst_processing_system7_0_100M1_peripheral_aresetn [get_bd_pins ModemS2Control_0/s00_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M12_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M13_ARESETN] [get_bd_pins rst_processing_system7_0_100M1/peripheral_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins DVBOutputBuffer_0/axi_aresetn] [get_bd_pins PWM_AXI_triple_0/s00_axi_aresetn] [get_bd_pins PWM_AXI_triple_3/s00_axi_aresetn] [get_bd_pins PWM_AXI_triple_4/s00_axi_aresetn] [get_bd_pins PWM_AXI_triple_5/s00_axi_aresetn] [get_bd_pins RC_0/s00_axi_aresetn] [get_bd_pins RC_1/s00_axi_aresetn] [get_bd_pins axi_gpio_led/s_axi_aresetn] [get_bd_pins axi_gpio_testpins/s_axi_aresetn] [get_bd_pins axi_gpio_video/s_axi_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins dvi2rgb_0/aRst_n] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M06_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M07_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M08_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M09_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M10_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M11_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins v_tc_0/s_axi_aresetn]
  ...
  connect_bd_net -net throttle_1 [get_bd_ports throttle] [get_bd_pins RC_0/RC_in0]
  connect_bd_net -net tuner_1 [get_bd_ports tuner] [get_bd_pins RC_1/RC_in3]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins processing_system7_0/SDIO0_WP] [get_bd_pins xlconstant_1/dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs DVBOutputBuffer_0/axi/axi_reg] SEG_DVBOutputBuffer_0_axi_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ModemS2Control_0/S00_AXI/S00_AXI_reg] SEG_ModemS2Control_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PWM_AXI_triple_0/S00_AXI/S00_AXI_reg] SEG_PWM_AXI_triple_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PWM_AXI_triple_3/S00_AXI/S00_AXI_reg] SEG_PWM_AXI_triple_3_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C50000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PWM_AXI_triple_4/S00_AXI/S00_AXI_reg] SEG_PWM_AXI_triple_4_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C60000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PWM_AXI_triple_5/S00_AXI/S00_AXI_reg] SEG_PWM_AXI_triple_5_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C80000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RC_0/S00_AXI/S00_AXI_reg] SEG_RC_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C90000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RC_1/S00_AXI/S00_AXI_reg] SEG_RC_1_S00_AXI_reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_testpins/S_AXI/Reg] SEG_axi_gpio_testpins_Reg
