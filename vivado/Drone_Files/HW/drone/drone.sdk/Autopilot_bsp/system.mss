...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -DUSE_AMP=1
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = DVBOutputBuffer_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = ModemS2Control_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = PWM_AXI_triple_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = PWM_AXI_triple_3
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = PWM_AXI_triple_4
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = PWM_AXI_triple_5
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = RC
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = RC_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = RC
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = RC_1
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.1
 PARAMETER HW_INSTANCE = axi_gpio_testpins
END
