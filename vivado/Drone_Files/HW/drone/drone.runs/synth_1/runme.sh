...
HD_PWD='/users/students/data/eagle4/Drone_files/Drone_Files/HW/drone/drone.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log drone_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source drone_wrapper.tcl
