...
HD_PWD='/users/students/data/eagle4/Drone_files/Drone_Files/HW/drone/drone.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log drone_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source drone_wrapper.tcl -notrace
