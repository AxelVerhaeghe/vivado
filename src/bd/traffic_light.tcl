...
################################################################
# This is a generated script based on design: traffic_light
#
...
# source traffic_light_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ddp_ex2_0, and set properties
  set ddp_ex2_0 [ create_bd_cell -type ip -vlnv user.org:user:ddp_ex2:1.0 ddp_ex2_0 ]

  # Create instance: ddp_traffic_light_clock_divider_0, and set properties
  set ddp_traffic_light_clock_divider_0 [ create_bd_cell -type ip -vlnv user.org:user:ddp_traffic_light_clock_divider:1.0 ddp_traffic_light_clock_divider_0 ]
  set_property -dict [ list CONFIG.COUNTER_MAX_VALUE {100000000}  ] $ddp_traffic_light_clock_divider_0

  # Create instance: processing_system7_0, and set properties
  set processing_system7_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:processing_system7:5.5 processing_system7_0 ]
  set_property -dict [ list CONFIG.PCW_APU_PERIPHERAL_FREQMHZ {100} \
...
CONFIG.PCW_USB0_RESET_ENABLE {1} CONFIG.PCW_USB0_RESET_IO {MIO 46} \
  ...
  connect_bd_net -net ddp_ex2_0_amber [get_bd_pins ddp_ex2_0/amber] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net ddp_ex2_0_green [get_bd_pins ddp_ex2_0/green] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net ddp_ex2_0_red [get_bd_pins ddp_ex2_0/red] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net ddp_traffic_light_clock_divider_0_clk_slow [get_bd_pins ddp_ex2_0/clk] [get_bd_pins ddp_traffic_light_clock_divider_0/clk_slow]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ddp_traffic_light_clock_divider_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ddp_ex2_0/resetn] [get_bd_pins ddp_traffic_light_clock_divider_0/resetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
