...
create_project montgomery_sw_project $origin_dir/../montgomery_sw_project

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects montgomery_sw_project]
...
# Create block design
source $origin_dir/bd/montgomery_sw.tcl
...
set obj [get_filesets sources_1]
set_property "top" "montgomery_sw_wrapper" $obj
...
set obj [get_filesets sim_1]
set_property "top" "montgomery_sw_project_wrapper" $obj
